  ...
  return (
    <div className="Sidebar">
      <ul className="Sidebar--list">
        <div className="Sidebar--list-item"><ListSymbol type="query" /><a>Query</a></div>
        <div className="Sidebar--list-item"><ListSymbol type="database" /> <a>{props.databaseName}</a></div>
        {tables}
      </ul>
    </div>
  );
