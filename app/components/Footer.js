  ...
  return (
    <div className="Footer" style={{ left: props.offset }}>
      <div className="FooterButtonContainer">
        <div className={props.pathname === '/home/content' ? activeFooterButton : footerButton}>
          <Link to="/home/content">Content</Link>
        </div>
        <div className={props.pathname === '/home/query' ? activeFooterButton : footerButton}>
          <Link to="/home/query">Query</Link>
        </div>
        <div className={props.pathname === '/home/structure' ? activeFooterButton : footerButton}>
          <Link to="/home/structure">Structure</Link>
        </div>
        <div className={props.pathname === '/home/graph' ? activeFooterButton : footerButton}>
