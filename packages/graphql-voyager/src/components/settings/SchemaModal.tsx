...
import buttonDarkTheme from './button-dark.theme.css';
import settingsDarkTheme from './settings-dark.theme.css';

import { Button, IconButton } from 'react-toolbox/lib/button';
import CloseIcon from '../icons/close-black.svg';
import { StateInterface } from '../../reducers';

import ClipboardButton from '@falcon-client/react-clipboard.js';
